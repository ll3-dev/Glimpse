...
function ItemContent({
  ...
  return (
    <>
      <View className="mr-3.5 h-8 w-8 items-center justify-center rounded-lg bg-app-bg border border-app-border/60 mt-0.5">
        <typeConfig.Icon size={15} color={appMuted} />
      </View>
      <View className="flex-1 min-w-0">
        <Text className="text-[15px] font-semibold text-app-text leading-snug tracking-tight" numberOfLines={2}>
          {displayTitle}
        </Text>
        <Text className="mt-1 text-xs text-app-muted font-normal">
          ...
          <View className="mt-2.5 flex-row flex-wrap gap-1.5">
            {labels.map((label) => (
              <Pressable
                ...
                className="rounded-md bg-tag-mint-bg/60 border border-tag-mint-text/20 px-2 py-0.5 active:opacity-70"
              >
            ...
            {tags.map((tag) => (
              <Pressable
                ...
                className="rounded-md bg-app-bg border border-app-border px-2 py-0.5 active:opacity-70"
              >
...
export const KnowledgeItemCard = memo(function KnowledgeItemCard({
  ...
  return (
    <Card className="mb-2.5 overflow-hidden border border-app-border bg-app-surface">
      <Pressable
