...
export function readCoreStore(): CoreStoreData {
...
export function writeCoreStore(data: CoreStoreData): void {
  writeRawStore(serializeStoreData(data));
}

export function updateCoreStore<T>(updater: (data: CoreStoreData) => T): T {
...
export const __localCoreStoreTestUtils = {
  getKey(): string {
