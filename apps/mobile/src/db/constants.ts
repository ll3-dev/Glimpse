...
export const REQUIRED_COLUMNS: RequiredColumn[] = [
  ...
  { name: "labels", definition: "labels TEXT" },
  { name: "provisional_labels", definition: "provisional_labels TEXT" },
  { name: "label_status", definition: "label_status TEXT DEFAULT 'idle'" },
  { name: "label_source", definition: "label_source TEXT DEFAULT 'none'" },
  { name: "label_version", definition: "label_version TEXT" },
  { name: "label_score", definition: "label_score REAL" },
  { name: "label_requested_at", definition: "label_requested_at REAL" },
  { name: "label_completed_at", definition: "label_completed_at REAL" },
  { name: "label_error", definition: "label_error TEXT" },
