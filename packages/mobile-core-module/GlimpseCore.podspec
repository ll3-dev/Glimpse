...
Pod::Spec.new do |s|
  ...
  s.user_target_xcconfig = {
    "LIBRARY_SEARCH_PATHS[sdk=iphoneos*]" => '"${PODS_ROOT}/../../packages/mobile-core-module/ios/framework/libglimpsecore.xcframework/ios-arm64"',
    "LIBRARY_SEARCH_PATHS[sdk=iphonesimulator*]" => '"${PODS_ROOT}/../../packages/mobile-core-module/ios/framework/libglimpsecore.xcframework/ios-arm64_x86_64-simulator"',
    "OTHER_LDFLAGS" => '$(inherited) -lglimpsecore-prebuilt',
  }
