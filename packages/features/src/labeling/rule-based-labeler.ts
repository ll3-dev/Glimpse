/**
 * Rule-based knowledge labeling shared by mobile and desktop.
 * Platform-specific labeling types stay in each app; this module only relies
 * on the structural shape of the item it labels.
 */
...
export type KnowledgeLabel = (typeof LABEL_PRIORITY)[number];
...
/** The structural slice of KnowledgeItem the labeler actually reads. */
...
export interface RuleBasedLabelingResult {
...
export function deriveRuleBasedLabels(item: LabelableItem): RuleBasedLabelingResult {
