...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::glimpse::FileLoadResult> final {
    static inline margelo::nitro::glimpse::FileLoadResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::glimpse::FileLoadResult(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::glimpse::FileLoadResult& arg) {
