...
namespace margelo::nitro::glimpse { enum class ColumnType; }
...
namespace margelo::nitro::glimpse {
   ...
   */
  struct SQLiteQueryColumnMetadata final {
  public:
  ...
  public:
    friend bool operator==(const SQLiteQueryColumnMetadata& lhs, const SQLiteQueryColumnMetadata& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::glimpse::SQLiteQueryColumnMetadata> final {
    static inline margelo::nitro::glimpse::SQLiteQueryColumnMetadata fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::glimpse::SQLiteQueryColumnMetadata(
        JSIConverter<std::string>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "name"))),
        JSIConverter<margelo::nitro::glimpse::ColumnType>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "type"))),
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "index")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::glimpse::SQLiteQueryColumnMetadata& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "name"), JSIConverter<std::string>::toJSI(runtime, arg.name));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "type"), JSIConverter<margelo::nitro::glimpse::ColumnType>::toJSI(runtime, arg.type));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::glimpse::ColumnType>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "type")))) return false;
