...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::glimpse::BatchQueryResult> final {
    static inline margelo::nitro::glimpse::BatchQueryResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::glimpse::BatchQueryResult(
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "rowsAffected")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::glimpse::BatchQueryResult& arg) {
