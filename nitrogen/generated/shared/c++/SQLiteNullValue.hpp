...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::glimpse::SQLiteNullValue> final {
    static inline margelo::nitro::glimpse::SQLiteNullValue fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::glimpse::SQLiteNullValue(
        JSIConverter<bool>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "isNitroSQLiteNull")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::glimpse::SQLiteNullValue& arg) {
