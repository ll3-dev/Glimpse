...
namespace margelo::nitro::glimpse { class HybridNativeQueryResultSpec; }
...
namespace margelo::nitro::glimpse { struct BatchQueryResult; }
// Forward declaration of `NativeBatchQueryCommand` to properly resolve imports.
namespace margelo::nitro::glimpse { struct NativeBatchQueryCommand; }
// Forward declaration of `FileLoadResult` to properly resolve imports.
namespace margelo::nitro::glimpse { struct FileLoadResult; }
